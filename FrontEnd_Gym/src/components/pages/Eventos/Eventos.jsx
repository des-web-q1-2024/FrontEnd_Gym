            ...
            <div className="col-lg-11 col-md-11 col-sm-12 col-xs-12 mt-5">
              <div className="card card-evento ">
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 d-flex justify-content-end gap-2">
                    <form class="row">
                  ...
                  <div className="row">
                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card bg-eventos" style={{ width: "18rem;" }}>
                        ...
                        />
                        <div class="card-body">
                          <h6 class="card-title text-white ff-inter">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card bg-eventos" style={{ width: "18rem;" }}>
                        ...
                        <div class="card-body">
                          <h6 class="card-title text-white ff-inter">
                            Pelea Osama bin Laden con Donald Trum.
                          </h6>
                          <span className="fecha-evento ff-inter">
                            20/5/2024
                          </span>
