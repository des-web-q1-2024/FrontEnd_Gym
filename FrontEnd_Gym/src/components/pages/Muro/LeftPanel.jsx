            ...
            <nav className="main-menu">
                <div>
                    <div className="user-info">
                        <img src="https://e7.pngegg.com/pngimages/312/283/png-clipart-man-s-face-avatar-computer-icons-user-profile-business-user-avatar-blue-face-thumbnail.png" alt="user" />
                ...
                <ThemeSwitcher /> {/* Añadir el componente de cambio de tema */}
            </nav>
        </>
    );
};
