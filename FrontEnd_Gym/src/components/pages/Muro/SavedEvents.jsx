...
const SavedEvents = () => {
  ...
  const getSavedEvents = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:3000/api/Muro/saveEvent/${ userLogin.id }`);
      ...
      <div className="col-12 px-0">
        {isLoading ? (
          ...
          savedEvents.map((evento) => (
            <div className="saved-event-card" key={evento.save_id || evento.id}>
              ...
              <div className="event-details">
                ...
                <p>Guardado el: {new Date(evento.date_save).toLocaleDateString()}</p>
